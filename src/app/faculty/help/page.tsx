...
export default function HelpSupportPage() {
  ...
  const handleSubmitTicket = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      setTicketNumber(`EX-SLA-${Math.floor(1000 + Math.random() * 9000)}`);
      setTicketSubject('');
      setTicketDesc('');
    }, 1500);
  };
  ...
  const faqs = [
    { q: 'How does the AI grading evaluation score suggested items?', a: 'Examiner AI cross-references students submissions with the context nodes uploaded in Study Materials, analyzing code structures or logical steps to recommend suggested marks.' },
    { q: 'How do I configure strict lockdown browser sandbox parameters?', a: 'When creating or scheduling an exam in Exams console, toggle Lockdown sandbox options to "Strict" to enforce full-screen focus and webcam gaze monitoring.' },
    { q: 'How do I download student grade CSV rosters?', a: 'Navigate to "My Classes > Roster", choose the desired class card, and click the Export CSV button at the top-right of the table.' }
  ];
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="p-5 rounded-2xl bg-white/40 dark:bg-white/5 border border-white/50 dark:border-white/5 flex items-center gap-3">
          ...
          <div>
            <span className="text-[10px] font-mono uppercase tracking-wider text-[#5C5868]/70 dark:text-[#9591A3]/50">Faculty Support Email</span>
            <p className="font-semibold text-[13px] text-[#1E1B24] dark:text-[#EDEAF2] mt-0.5">faculty-sla@examinerai.com</p>
          </div>
        </div>
        ...
        <div className="p-5 rounded-2xl bg-white/40 dark:bg-white/5 border border-white/50 dark:border-white/5 flex items-center gap-3">
          ...
          <div>
            <span className="text-[10px] font-mono uppercase tracking-wider text-[#5C5868]/70 dark:text-[#9591A3]/50">Dedicated SLA Phone</span>
            <p className="font-semibold text-[13px] text-[#1E1B24] dark:text-[#EDEAF2] mt-0.5">+1 (800) 555-0199</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        {/* Left Column: FAQs & documentation search */}
        <div className="lg:col-span-7 p-6 rounded-2xl bg-white/55 dark:bg-white/5 border border-white/60 dark:border-white/10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] space-y-4">
          ...
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Search guides, RAG integrations, or proctor logs..."
        ...
        <div className="lg:col-span-5 p-6 rounded-2xl bg-white/55 dark:bg-white/5 border border-white/60 dark:border-white/10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] space-y-4">
          ...
          <form onSubmit={handleSubmitTicket} className="space-y-3 text-[12.5px]">
            <div className="space-y-1.5">
              ...
              <input
                type="text"
                placeholder="e.g. RAG PDF indexing is slow"
                value={ticketSubject}
            ...
            <div className="space-y-1.5">
              ...
              >
                ...
                <option value="Urgent">Urgent (4h Callout)</option>
              </select>
            </div>
